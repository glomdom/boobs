...
BOOBS_API b8 input_is_key_down(keys key);
BOOBS_API b8 input_is_key_up(keys key);
BOOBS_API b8 input_was_key_down(keys key);
BOOBS_API b8 input_was_key_up(keys key);

void input_process_key(keys key, b8 pressed);

BOOBS_API b8 input_is_button_down(buttons button);
BOOBS_API b8 input_is_button_up(buttons button);
BOOBS_API b8 input_was_button_down(buttons button);
BOOBS_API b8 input_was_button_up(buttons button);
BOOBS_API void input_get_mouse_position(i32* x, i32* y);
BOOBS_API void input_get_previous_mouse_position(i32* x, i32* y);
